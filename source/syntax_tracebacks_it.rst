...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\except_no_try.py'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\except_or_finally.py'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\finally_no_try.py'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file '<string>'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\missing_in_with_for.py'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\scientific_notation_missing_exponent.py'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\typo_in_except.py'
    nella posizione indicata.
...
.. code-block:: none
    ...
    Python non riesce ad interpretare il codice contenuto nel file 'TESTS:\syntax\typo_in_finally.py'
    nella posizione indicata.
